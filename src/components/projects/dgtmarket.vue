  ...
  <div class="section-top">
    ...
    <div class="c-dark">
      <div class="container project-study text-left">
        <div class="grid padding-2/1-top">
          <div class="grid-item 1/2 compact-1/1 text-left">
            ...
            <p class="padding-top text-left white-space">dgtmarket.com is a modern exchange platform that allows to buy and sell Bitcoin and Litecoin. Their landing page needed refreshing - the idea was to design it in a more engaging interactive way and present the new content. The main impact was put on graphic solutions and content structure.</p>
          </div>
      ...
      <div class="container">
        ...
        <img src="../../assets/projects/dgt/2.png" class="project-img" alt="hero graphic">
        <img src="../../assets/projects/dgt/3.png" class="project-img" alt="project graphics">
        <img src="../../assets/projects/dgt/4.png" class="project-img" alt="project graphics and icons">
        <img src="../../assets/projects/dgt/5.png" class="project-img" alt="landing page">
        <img src="../../assets/projects/dgt/6.png" class="project-img" alt="landing page">
        <img src="../../assets/projects/dgt/7.png" class="project-img" alt="typography and colors">
      </div>
    </div>
    <contact></contact>
    <appFooter></appFooter>
